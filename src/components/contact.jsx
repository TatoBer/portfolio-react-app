...
export default function Contact() {
  return (
    <div className='contact-container'>
        ...
        <h2 className='abm-h2'>CONTACT</h2>
        <div className='cont-a-div'>
        <a className='contact-div' target="_blank" href="https://api.whatsapp.com/send?phone=543412676961&text=Hello,%20I%20contact%20you%20to%20consult%20for%20a%20customized%20web%20page">
