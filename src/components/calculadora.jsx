    ...
    <>
      <div className="calculadora closed">
        ...
        <div className="botones-div">
          <div className="fila">
            <BotonCalc click={borrarTodo} tipo="operador">
              C
            </BotonCalc>
            <BotonCalc click={agregarInput} tipo="operador">
              /
            </BotonCalc>
            <BotonCalc click={agregarInput} tipo="operador">
              *
            </BotonCalc>
            <BotonCalc click={borrarUlt} tipo="operador">
              🢘
            </BotonCalc>
          </div>
          <div className="fila">
            <BotonCalc click={agregarInput} tipo="numero">
              7
            </BotonCalc>
            <BotonCalc click={agregarInput} tipo="numero">
              8
          ...
          <div className="fila">
            ...
            <BotonCalc click={calcular} tipo="operador">
              =
            </BotonCalc>
          </div>
          <div className="fila">
